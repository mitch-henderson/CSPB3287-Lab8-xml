/* src/config/xqilla_config_unix.h.  Generated from xqilla_config_unix.h.in by configure.  */
/* src/config/xqilla_config_unix.h.in.  Generated from configure.in by autoheader.  */
...
/* Name of package */
#define PACKAGE "XQilla"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT ""

/* Define to the full name of this package. */
#define PACKAGE_NAME "XQilla"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "XQilla 2.3.4"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "xqilla"
